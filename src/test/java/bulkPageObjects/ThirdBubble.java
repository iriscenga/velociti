...
public class ThirdBubble {
    ...
    @FindBy (xpath = "//div[normalize-space()='Pending Provider Confirmation']")
    ...
    public ThirdBubble(WebDriver driver){
        this.driver = driver;
    ...
    public void checkDeactivateProcess() throws InterruptedException{
        ...
        element= wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[contains(text(),'Asset Sold')]")));
        element.click();
        setApply();
        Thread.sleep(1000);
